...
static void usage()
{
    printf("Usage: edb-key-demo TA [OPTION]... [IMG]\n\
Enclave Device Confidential Computing key demo.\n\
\n\
If IMG is provided the demo will classify the supplied picture of a key.\n\
For sample images see the samples/ directory of the project.\n\
...
int main(int argc, char *argv[])
{
    ...
    while (1) {
        ...
        int opt_index = 0;
        c = getopt_long(argc, argv, "hc:d:", long_opts, &opt_index);
        if (c == -1)
            break;
